...
<head>
    ...
    <link href="/assets/Cron/themes/bootstrap/easyui.min.css" rel="stylesheet" type="text/css"/>
    <link href="/assets/Cron/themes/icon.css" rel="stylesheet" type="text/css"/>
    <link href="/assets/Cron/icon.css" rel="stylesheet" type="text/css"/>
    <style type="text/css">
        .line {
            height: 25px;
            line-height: 25px;
...
<script src="/assets/Cron/jquery-1.6.2.min.js" type="text/javascript"></script>
<script src="/assets/Cron/jquery.easyui.min.js" type="text/javascript"></script>
<script src="/assets/Cron/cron.js" type="text/javascript"></script>
</body>
</html>